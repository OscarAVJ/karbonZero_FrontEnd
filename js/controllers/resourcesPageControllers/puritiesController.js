          ...
          <tbody>
            ${puritites.map((r, i) => `
              <tr>
                ...
                <td>${r.resourcePurityMeasureUnit}</td>
                <td>${r.purity}</td>
                <td>
                    <button class="btn btn-sm btn-success me-1 btn-edit-purity" data-id="${r.idResourcePurity}" data-bs-toggle="modal" data-bs-target="#purezaModal"><i class="bi bi-pencil-fill"></i></button>
                    <button class="btn btn-sm btn-danger btn-delete-purity" data-id="${r.idResourcePurity}"><i class="bi bi-trash-fill"></i></button>
                </td>
              </tr>`).join('')}
          </tbody>
        </table>
